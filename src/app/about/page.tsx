...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      ...
      <Section background="light-gray" padding="xl">
        <Container>
          <div className="grid grid-cols-12 gap-16 max-w-7xl mx-auto">
            {/* 左側：タイトル + Point一覧 - 30% */}
            <div className="col-span-12 lg:col-span-4">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <Typography variant="heading-sm" className="text-dark-gray leading-tight">
            ...
            <div className="col-span-12 lg:col-span-8">
              <div className="space-y-12">
                {/* Point 1 詳細 */}
                <div>
                  <Typography variant="body-lg" className="text-dark-gray leading-relaxed mb-6 font-medium">
