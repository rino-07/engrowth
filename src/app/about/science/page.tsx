      ...
      <Section background="light-gray" className="py-12 sm:py-16 lg:py-24">
        <Container>
          <div className="bg-gray-50 rounded-2xl shadow-inner p-8">
            ...
            {/* モバイル: Sticky タイトル + 横スクロール */}
            <div className="md:hidden relative">
              <div className="sticky top-0 z-10 bg-gray-50/90 backdrop-blur py-2 -mx-8 px-8">
                <Typography variant="heading-lg" className="text-dark-gray text-center font-serif">
                  「5つのステップ」
                </Typography>
              </div>
              <div 
                className="mt-6 flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-4"
                role="region" 
                aria-label="5つのステップ"
                style={{
              ...
              >
                <article className="snap-center shrink-0 w-[75vw] rounded-xl border bg-white p-4 shadow-md">
                  <div className="text-3xl mb-2 text-center">📚</div>
                  <Typography variant="body-sm" className="font-bold mb-2 text-center" style={{color: '#d30306'}}>
                    1. INPUT（インプット）の質と量
                  </Typography>
                  <Typography variant="body-sm" className="text-gray-700 leading-relaxed text-center">
                    「意識的に」スピード＋リスニング力を高め、視聴できる言語範囲を広げます。
                  </Typography>
                </article>
